...
| --- | --- |
| [jsDelivr](https://www.jsdelivr.com/) | CDN for frontend libraries and a small number of inherited static assets. |
...
| Project | Credit |
| --- | --- |
| [SimonAKing/HomePage](https://github.com/SimonAKing/HomePage) | Original homepage structure, intro style, and some inherited CDN assets. This repo now documents the project as Junle Chen's independent personal homepage. |
