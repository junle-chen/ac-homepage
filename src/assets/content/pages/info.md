...
- **Jul 2023**: AI Cloud-Based Scientific Research with Data-Driven Knowledge, LAMDA, Nanjing University.
- **Sept 2025 -**: PhD in Computer Science and Engineering, The Hong Kong University of Science and Technology. Under the guidance of Professor Xiaofang Zhou.
...
- [M^3Exam: Benchmarking Multimodal Memory for Realistic User-Agent Interactions](https://arxiv.org/abs/2606.07402)  
  ...
  *arXiv preprint arXiv:2606.07402, 2026*
...
- [LifeSide: Benchmarking Agents as Lifelong Digital Companions](https://arxiv.org/abs/2606.04660)  
  ...
  *arXiv preprint arXiv:2606.04660, 2026*
...
- [Learning from Complexity: Exploring Dynamic Sample Pruning of Spatio-Temporal Training](https://arxiv.org/abs/2602.19113)  
  ...
  *arXiv preprint arXiv:2602.19113, 2026*

- [Adaptive Indexing for Coverage Queries over Transition Trajectories](https://doi.org/10.1007/s11280-025-01368-6)  
  Jian Chen†, **Junle Chen**†, Donghua Yang, Guangyu Sui, Jinbao Wang, Lina Chen.  
  *World Wide Web, 2025*

- [Maximizing Influence Query over Indoor Trajectories](https://doi.org/10.1109/TKDE.2024.3514323)  
...
- [Efficient Coverage Query over Transition Trajectories](https://doi.org/10.1007/978-981-97-7235-3_32)  
  Jian Chen, **Junle Chen**, Hong Gao, Donghua Yang, Kaiqi Zhang.  
  *APWeb-WAIM, 2024*
...
- Email: [jchenkg@connect.ust.hk](mailto:jchenkg@connect.ust.hk)
- Phone: [+852 56029402](tel:+85256029402)
